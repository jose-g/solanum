...
/* global array_18 */
/* global array_17 */
char simile_identifier[] = "program='AME',version=4.9,edition=enterprise,date=unused,size=237,";
int phasecount = 1;
int paramcount = 6;
double ts[2];
double dts[2];
...
int array_0[2] = {18, 1};
int array[2] = {10, 1};
double array_13[11] = {0.82, 195.0686, 802.5832, 2.3, 0.86, 506.8706, 208.7195, 0.2, -3.0, -5.0, -8.0};
double array_12[11] = {0.5, 750, 1400, 2.3, 0.91, 678.9962, 185.3471, 0.2, -3.0, -5.0, -8.0};
double array_11[11] = {0.92, 309.902, 777.3213, 2.3, 0.79, 584.6548, 186.319, 0.2, -3.0, -5.0, -8.0};
double array_10[11] = {0.8559, 140.5, 959.8, 2.3, 0.9511, 519.2, 341.1, 0.2, -3.0, -5.0, -8.0};
double array_9[11] = {0.9002, 204.8, 833.6, 2.3, 0.9532, 447, 337.9, 0.2, -3.0, -5.0, -8.0};
double array_8[11] = {0.93, 275.6, 818.5, 2.3, 0.8053, 712, 127.2, 0.2, 2.4, -5.0, -7.0};
int array_16[3] = {4, 23, 30};
int array_15[3] = {2, 20, 28};
int array_14[3] = {0, 17, 25};
double array_28[7] = {1.51, 47, 32, 20, 125, 5.7, 3847.3};
double array_27[7] = {1.48, 50, 39, 27, 75, 10.6, 4172.3};
double array_26[7] = {1.46, 41, 22, 10, 500, 1.7, 3052.8};
double array_25[7] = {1.44, 38, 16, 8, 800, 1.8, 2627.0};
double array_24[7] = {1.44, 46, 31, 15, 250, 2.8, 3533.1};
double array_23[7] = {1.42, 36, 13, 6, 1500, 1.8, 2390.6};
double array_22[7] = {1.4, 50, 39, 23, 100, 7, 3863.0};
double array_21[7] = {1.37, 46, 33, 13, 150, 1.4, 3404.6};
double array_20[7] = {1.37, 43, 33, 9, 50, 1.4, 3404.6};
double array_19[7] = {1.36, 55, 54, 39, 2, 11, 4567.7};
double array_18[7] = {1.3, 52, 44, 23, 120, 6.4, 3862.5};
double array_17[7] = {1.24, 54, 50, 32, 15, 10.9, 3845.3};
char* inputArcs[] = {"end"};
...
void* get_pointer (int id, int** dims) {
    ...
    class Sol_integral_2012_Tor_9394_9_NewEq2013type : public submodeltype {
    public:
        Sol_integral_2012_Tor_9394_9_NewEq2013type () {
        }; /* end(procedure,structor) */
        ~Sol_integral_2012_Tor_9394_9_NewEq2013type () {
        }; /* end(procedure,structor) */
...
}; /* end(class,Sol_integral_2012_Tor_9394_9_NewEq2013type) */
...
public:
    ...
    Sol_integral_2012_Tor_9394_9_NewEq2013type Sol_integral_2012_Tor_9394_9_NewEq2013;
void* get_pointer (int id, int** dims) {
    switch (id) {
        case 1:
        return(&(Sol_integral_2012_Tor_9394_9_NewEq2013));
        break; /* 1 */
    }; /* end(switch,id) */
    return(NULL);
}; /* end(procedure,get_pointer) */
...
/* STRUCTURE POINTER DECLARATIONS */
    ...
    Sol_integral_2012_Tor_9394_9_NewEq2013type* Sol_integral_2012_Tor_9394_9_NewEq2013pointer;


    /* UPDATE FUNCTION VALUES */

if (1>=phase) {
    Sol_integral_2012_Tor_9394_9_NewEq2013pointer = &(this->Sol_integral_2012_Tor_9394_9_NewEq2013);
        Nitrogen_limited_productionpointer = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer->Nitrogen_limited_production);
            Total_dry_matter_production_Npointer = &(Nitrogen_limited_productionpointer->Total_dry_matter_production_N);
                Frost_limited_productionpointer = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer->Frost_limited_production);
                    Total_dry_matter_prod_Fpointer = &(Frost_limited_productionpointer->Total_dry_matter_prod_F);
                        Potential_productionpointer = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer->Potential_production);
                            Total_dry_matter_productionpointer = &(Potential_productionpointer->Total_dry_matter_production);
                                Water_limited_productionpointer = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer->Water_limited_production);
                                    Total_dry_matter_production_Wpointer = &(Water_limited_productionpointer->Total_dry_matter_production_W);
                                        Water_stresspointer = &(Water_limited_productionpointer->Water_stress);
                                            Soil_water_Balancepointer = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer->Soil_water_Balance);
                                                Thermal_timepointer = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer->Thermal_time);
                                                    N_dynamicspointer = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer->N_dynamics);
...
/* STRUCTURE POINTER DECLARATIONS */
    ...
    Sol_integral_2012_Tor_9394_9_NewEq2013type* Sol_integral_2012_Tor_9394_9_NewEq2013pointer_0;


    /* UPDATE FUNCTION VALUES */

if (1>=phase) {
    Sol_integral_2012_Tor_9394_9_NewEq2013pointer_0 = &(this->Sol_integral_2012_Tor_9394_9_NewEq2013);
        Frost_limited_productionpointer_0 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_0->Frost_limited_production);
...
/* STRUCTURE POINTER DECLARATIONS */
    ...
    Water_limited_productiontype* Water_limited_productionpointer_3;
    IMMOBIXNWtype* IMMOBIXNWpointer_2;
    MIN_FOMAtype* MIN_FOMApointer_3;
    N_dynamicstype* N_dynamicspointer_3;
    Sol_integral_2012_Tor_9394_9_NewEq2013type* Sol_integral_2012_Tor_9394_9_NewEq2013pointer_3;
    Randomizetype* Randomizepointer_1;
    ...
    Total_dry_matter_prod_Ftype* Total_dry_matter_prod_Fpointer_2;
    ...
    Sol_integral_2012_Tor_9394_9_NewEq2013type* Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2;
    int loop_2;
    int loop_1;
    int loop_0;
    int loop;
    ...
    Sol_integral_2012_Tor_9394_9_NewEq2013type* Sol_integral_2012_Tor_9394_9_NewEq2013pointer_1;


    /* UPDATE FUNCTION VALUES */

if (-2>=phase) {
    Sol_integral_2012_Tor_9394_9_NewEq2013pointer_1 = &(this->Sol_integral_2012_Tor_9394_9_NewEq2013);
        N_dynamicspointer_0 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_1->N_dynamics);
            MIN_FOMApointer_0 = &(N_dynamicspointer_0->MIN_FOMA);
                Type_of_OM_addedpointer = &(MIN_FOMApointer_0->Type_of_OM_added);
                    Nitrogen_limited_productionpointer_0 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_1->Nitrogen_limited_production);
                        Total_dry_matter_production_Npointer_0 = &(Nitrogen_limited_productionpointer_0->Total_dry_matter_production_N);
                            Varietypointer = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_1->Variety);
                                Frost_limited_productionpointer_1 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_1->Frost_limited_production);
                                    Potential_productionpointer_0 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_1->Potential_production);
                                        Tuber_productionpointer = &(Potential_productionpointer_0->Tuber_production);
                                            Total_dry_matter_productionpointer_0 = &(Potential_productionpointer_0->Total_dry_matter_production);
                                                Canopy_coverpointer = &(Potential_productionpointer_0->Canopy_cover);
                                                    Thermal_timepointer_0 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_1->Thermal_time);
                                                        MIN_HUMUSpointer_0 = &(N_dynamicspointer_0->MIN_HUMUS);
                                                            Soil_parameterspointer = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_1->Soil_parameters);
                                                                Soil_temp_estpointer = &(Soil_parameterspointer->Soil_temp_est);
                                                                    N_stresspointer = &(Nitrogen_limited_productionpointer_0->N_stress);
                                                                        Total_dry_matter_prod_Fpointer_0 = &(Frost_limited_productionpointer_1->Total_dry_matter_prod_F);
                                                                            Water_limited_productionpointer_0 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_1->Water_limited_production);
                                                                                UREA_HYDpointer_0 = &(N_dynamicspointer_0->UREA_HYD);
                                                                                    NITRIFXNWpointer_0 = &(N_dynamicspointer_0->NITRIFXNW);
                                                                                        Randomizepointer = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_1->Randomize);
                                                                                            Timepointer = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_1->Time);
                                                                                                Planting_Datepointer = &(Timepointer->Planting_Date);
                                                                                                    FERTILIZERSpointer = &(N_dynamicspointer_0->FERTILIZERS);
                                                                                                        ...
                                                                                                        //Varietypointer->Var_Name = 5;
                                                                                                        //Thermal_timepointer_0->Thermal_conditions = 2;
                                                                                                        //Planting_Datepointer->dd = 12;
                                                                                                        //Planting_Datepointer->mm = 7;
                                                                                                        ...
                                                                                                        //Soil_parameterspointer->OM = 39;
                                                                                                        Soil_parameterspointer->OC = 0.58*Soil_parameterspointer->OM;
                                                                                                        //Soil_parameterspointer->ISM = 35;
                                                                                                        ...
                                                                                                        Water_limited_productionpointer_0->RUEs = 1;
                                                                                                        Total_dry_matter_prod_Fpointer_0->RUEs_0 = Water_limited_productionpointer_0->RUEs;
                                                                                                        //Canopy_coverpointer->N = 4.17;
                                                                                                        N_stresspointer->GC0 = 0.6;
                                                                                                        N_stresspointer->GC250 = 1;
                                                                                                        for ( loop = 1; 7>=loop; ++loop ) {
                                                                                                            Soil_parameterspointer->Hydric[loop-1] = (Soil_parameterspointer->Soil_texture==1?array_17[loop-1]:(Soil_parameterspointer->Soil_texture==2?array_18[loop-1]:(Soil_parameterspointer->Soil_texture==3?array_19[loop-1]:(Soil_parameterspointer->Soil_texture==4?array_20[loop-1]:(Soil_parameterspointer->Soil_texture==5?array_21[loop-1]:(Soil_parameterspointer->Soil_texture==6?array_22[loop-1]:(Soil_parameterspointer->Soil_texture==7?array_23[loop-1]:(Soil_parameterspointer->Soil_texture==8?array_24[loop-1]:(Soil_parameterspointer->Soil_texture==9?array_25[loop-1]:(Soil_parameterspointer->Soil_texture==10?array_26[loop-1]:(Soil_parameterspointer->Soil_texture==11?array_27[loop-1]:array_28[loop-1])))))))))));
                                                                                                        }; /* end(for,loop) */
                                                                                                        ...
                                                                                                        for ( loop_0 = 1; 3>=loop_0; ++loop_0 ) {
                                                                                                            Thermal_timepointer_0->TC[loop_0-1] = (Thermal_timepointer_0->Thermal_conditions==1?array_14[loop_0-1]:(Thermal_timepointer_0->Thermal_conditions==2?array_15[loop_0-1]:array_16[loop_0-1]));
                                                                                                        }; /* end(for,loop_0) */
                                                                                                        ...
                                                                                                        for ( loop_1 = 1; 11>=loop_1; ++loop_1 ) {
                                                                                                            Varietypointer->Inputs[loop_1-1] = (Varietypointer->Var_Name==1?array_8[loop_1-1]:(Varietypointer->Var_Name==2?array_9[loop_1-1]:(Varietypointer->Var_Name==3?array_10[loop_1-1]:(Varietypointer->Var_Name==4?array_11[loop_1-1]:(Varietypointer->Var_Name==5?array_12[loop_1-1]:array_13[loop_1-1])))));
                                                                                                        }; /* end(for,loop_1) */

                                                                                                        //Canopy_coverpointer->tm = Varietypointer->Inputs[2-1];
                                                                                                        //Canopy_coverpointer->te = Varietypointer->Inputs[3-1];
                                                                                                        //Canopy_coverpointer->ym = Varietypointer->Inputs[1-1];
                                                                                                        //Total_dry_matter_productionpointer_0->RUE = Varietypointer->Inputs[4-1];
                                                                                                        //Tuber_productionpointer->r = Varietypointer->Inputs[5-1];
                                                                                                        //Tuber_productionpointer->s_0 = Varietypointer->Inputs[6-1];
                                                                                                        //Tuber_productionpointer->t = Varietypointer->Inputs[7-1];
                                                                                                        //Tuber_productionpointer->DMcont = Varietypointer->Inputs[8-1];
...
if (-1>=phase) {
    Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2 = &(this->Sol_integral_2012_Tor_9394_9_NewEq2013);
        Weatherpointer = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Weather);
...
if (0>=phase) {
    Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2 = &(this->Sol_integral_2012_Tor_9394_9_NewEq2013);
        Frost_limited_productionpointer_2 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Frost_limited_production);
            Nitrogen_limited_productionpointer_1 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Nitrogen_limited_production);
                Total_dry_matter_production_Npointer_1 = &(Nitrogen_limited_productionpointer_1->Total_dry_matter_production_N);
                    Total_dry_matter_prod_Fpointer_1 = &(Frost_limited_productionpointer_2->Total_dry_matter_prod_F);
                        Potential_productionpointer_1 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Potential_production);
                            Total_dry_matter_productionpointer_1 = &(Potential_productionpointer_1->Total_dry_matter_production);
                                Water_limited_productionpointer_1 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Water_limited_production);
                                    Total_dry_matter_production_Wpointer_0 = &(Water_limited_productionpointer_1->Total_dry_matter_production_W);
                                        Randomizepointer_0 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Randomize);
                                            Thermal_timepointer_1 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Thermal_time);
                                                N_dynamicspointer_1 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->N_dynamics);
                                                                ...
                                                                IMMOBIXNWpointer_0 = &(MIN_FOMApointer_1->IMMOBIXNW);
                                                                    NITRIFXNWpointer_1 = &(N_dynamicspointer_1->NITRIFXNW);
                                                                        FERTILIZERSpointer_0 = &(N_dynamicspointer_1->FERTILIZERS);
                                                                            Soil_water_Balancepointer_0 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Soil_water_Balance);
                                                                                Soil_parameterspointer_0 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Soil_parameters);
                                                                                    ...
                                                                                    }while(Randomizepointer_0->rnd_at_init<0.0001 || Randomizepointer_0->rnd_at_init>0.9999);
                                                                                    ...
                                                                                    Total_dry_matter_prod_Fpointer_1->TDMf = 0;
                                                                                    ...
                                                                                    Frost_limited_productionpointer_2->C3 = 0.00368;
...
if (1>=phase) {
    Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2 = &(this->Sol_integral_2012_Tor_9394_9_NewEq2013);
        Frost_limited_productionpointer_2 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Frost_limited_production);
            Nitrogen_limited_productionpointer_2 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Nitrogen_limited_production);
                    ...
                    Weatherpointer = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Weather);
                        Canopy_cover_Npointer = &(Nitrogen_limited_productionpointer_2->Canopy_cover_N);
                            N_stresspointer_0 = &(Nitrogen_limited_productionpointer_2->N_stress);
                                Potential_productionpointer_2 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Potential_production);
                                    Canopy_coverpointer_0 = &(Potential_productionpointer_2->Canopy_cover);
                                        Total_dry_matter_prod_Fpointer_2 = &(Frost_limited_productionpointer_2->Total_dry_matter_prod_F);
                                            Total_dry_matter_productionpointer_2 = &(Potential_productionpointer_2->Total_dry_matter_production);
                                                Water_limited_productionpointer_2 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Water_limited_production);
                                                    Total_dry_matter_production_Wpointer_1 = &(Water_limited_productionpointer_2->Total_dry_matter_production_W);
                                                        Water_stresspointer_0 = &(Water_limited_productionpointer_2->Water_stress);
                                                            Soil_water_Balancepointer_1 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Soil_water_Balance);
                                                                Soil_parameterspointer_1 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Soil_parameters);
                                                                    Timepointer_0 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Time);
                                                                        Thermal_timepointer_2 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Thermal_time);
                                                                            N_dynamicspointer_2 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->N_dynamics);
                                                                                                            ...
                                                                                                            Tuber_production_Npointer = &(Nitrogen_limited_productionpointer_2->Tuber_production_N);
                                                                                                                Tuber_productionpointer_0 = &(Potential_productionpointer_2->Tuber_production);
                                                                                                                    Tuber_production_Fpointer = &(Frost_limited_productionpointer_2->Tuber_production_F);
                                                                                                                        Tuber_production_Wpointer = &(Water_limited_productionpointer_2->Tuber_production_W);
                                                                                                                            Randomizepointer_1 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Randomize);
...
//                                                                                                                                Canopy_coverpointer_0->canopy = Canopy_coverpointer_0->ym*exp(-((double)(Canopy_coverpointer_0->tm)/(Thermal_timepointer_2->Tac*Canopy_coverpointer_0->N)))*(1+(double)(Canopy_coverpointer_0->te-Thermal_timepointer_2->Tac)/(Canopy_coverpointer_0->te-Canopy_coverpointer_0->tm))*pow((double)(Thermal_timepointer_2->Tac)/Canopy_coverpointer_0->te,(double)(Canopy_coverpointer_0->te)/(Canopy_coverpointer_0->te-Canopy_coverpointer_0->tm));
                                                                                                                                Canopy_coverpointer_0->canopy = Canopy_coverpointer_0->ym*(1+(double)(Canopy_coverpointer_0->te-Thermal_timepointer_2->Tac)/(Canopy_coverpointer_0->te-Canopy_coverpointer_0->tm))*pow((double)(Thermal_timepointer_2->Tac)/Canopy_coverpointer_0->te,(double)(Canopy_coverpointer_0->te)/(Canopy_coverpointer_0->te-Canopy_coverpointer_0->tm));
                                                                                                                                Canopy_coverpointer_0->canopy1 = Randomizepointer_1->rdm*Randomizepointer_1->v*Canopy_coverpointer_0->canopy+Canopy_coverpointer_0->canopy;
                                                                                                                                Tuber_productionpointer_0->Part = Tuber_productionpointer_0->r*exp(-(exp((double)(-(Thermal_timepointer_2->Tac-Tuber_productionpointer_0->s_0))/Tuber_productionpointer_0->t)));
                                                                                                                                ...
                                                                                                                                Tuber_production_Fpointer->DTYf = Total_dry_matter_prod_Fpointer_2->TDMf*Tuber_productionpointer_0->Part;
                                                                                                                                ...
                                                                                                                                Weatherpointer->tt = Weatherpointer->TT[(int)(Timepointer_0->day)-1];
                                                                                                                                Thermal_timepointer_2->Tav = (double)(Weatherpointer->Tmax+Weatherpointer->Tmin)/2;
                                                                                                                                Thermal_timepointer_2->Tac = Weatherpointer->tt;
                                                                                                                                ...
                                                                                                                                Canopy_coverpointer_0->CC = (Timepointer_0->DAE<=0?0:(Canopy_coverpointer_0->canopy1>0?Canopy_coverpointer_0->canopy1:pow(10,-6)));
                                                                                                                                Soil_water_Balancepointer_1->Eo = Canopy_coverpointer_0->ym*Weatherpointer->ETo*exp(-0.7*4*Canopy_coverpointer_0->CC);
                                                                                                                                Soil_water_Balancepointer_1->To_0 = (Canopy_coverpointer_0->CC==0?0.0001:(double)(1.1*Weatherpointer->ETo*(1-exp(-0.7*4*Canopy_coverpointer_0->CC)))/(1-exp(-0.7*4*Canopy_coverpointer_0->ym)));
                                                                                                                                ...
                                                                                                                                Total_dry_matter_production_Wpointer_1->RUEw = ((double)(Water_limited_productionpointer_2->RUEs*(0.8-Water_stresspointer_0->Ws))/0.8<0?0:(double)(Water_limited_productionpointer_2->RUEs*(0.8-Water_stresspointer_0->Ws))/0.8);
                                                                                                                                Total_dry_matter_productionpointer_2->dW = (double)(Total_dry_matter_productionpointer_2->RUE*Canopy_coverpointer_0->CC*Weatherpointer->PAR)/100;
                                                                                                                                Frost_limited_productionpointer_2->CC_0 = Canopy_coverpointer_0->CC;
                                                                                                                                ...
                                                                                                                                Total_dry_matter_prod_Fpointer_2->dTDM_0 = (double)(Frost_limited_productionpointer_2->CCf*Weatherpointer->PAR*Total_dry_matter_prod_Fpointer_2->RUEs_0)/100;
                                                                                                                                Canopy_cover_Npointer->CCn = Canopy_coverpointer_0->CC*N_stresspointer_0->Ns;
...
if (0>=phase) {
    Sol_integral_2012_Tor_9394_9_NewEq2013pointer_3 = &(this->Sol_integral_2012_Tor_9394_9_NewEq2013);
        N_dynamicspointer_3 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_3->N_dynamics);
            MIN_FOMApointer_3 = &(N_dynamicspointer_3->MIN_FOMA);
                IMMOBIXNWpointer_2 = &(MIN_FOMApointer_3->IMMOBIXNW);
                    Water_limited_productionpointer_3 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_3->Water_limited_production);
                        Water_stresspointer_1 = &(Water_limited_productionpointer_3->Water_stress);
...
if (1>=phase) {
    Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2 = &(this->Sol_integral_2012_Tor_9394_9_NewEq2013);
        Water_limited_productionpointer_2 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Water_limited_production);
            Total_dry_matter_production_Wpointer_2 = &(Water_limited_productionpointer_2->Total_dry_matter_production_W);
                Weatherpointer_0 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Weather);
                    Canopy_Cover_Wpointer = &(Water_limited_productionpointer_2->Canopy_Cover_W);
                        Potential_productionpointer_3 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->Potential_production);
                            Canopy_coverpointer_1 = &(Potential_productionpointer_3->Canopy_cover);
                                Water_stresspointer_2 = &(Water_limited_productionpointer_2->Water_stress);
                                    N_dynamicspointer_2 = &(Sol_integral_2012_Tor_9394_9_NewEq2013pointer_2->N_dynamics);
                                        MIN_FOMApointer_2 = &(N_dynamicspointer_2->MIN_FOMA);
                                                ...
                                                FERTILIZERSpointer_1 = &(N_dynamicspointer_2->FERTILIZERS);
                                                    IMMOBIXNWpointer_1 = &(MIN_FOMApointer_2->IMMOBIXNW);
                                                        MIN_HUMUSpointer_3 = &(N_dynamicspointer_2->MIN_HUMUS);
                                                            ...
                                                            Canopy_Cover_Wpointer->CCw = (Water_stresspointer_2->CWs>75?0:(double)(75-Water_stresspointer_2->CWs)/75*Canopy_coverpointer_1->CC);
...
char Sol_integral_2012_Tor_9394_9_NewEq2013_name[] = "Sol integral 2012 Tor 9394 9_NewEq2013";
...
char ay2_name[] = "ay2";
char C3_name[] = "C3";
char C3_spec[] = "0.00368";
char C3_comment[] = "\n\
Expresion f0\n\
\n\
OBS. Mayo 2013. Se reemplazo por un valor constante promedio de los parametros medidos";
char CCf_name[] = "CCf";
char fccf_name[] = "fccf";
char Tcr_name[] = "Tcr";
...
char rnd_comment[] = "Random constant";
char rdm_name[] = "rdm";
...
char Inputs_spec[] = "if Var_Name ==1 then[0.93,275.6,818.5,2.3,0.8053,712,127.2,0.2,2.4,-5.0,-7.0]\n\
elseif Var_Name==2 then [0.9002,204.8,833.6,2.3,0.9532,447,337.9,0.2,-3.0,-5.0,-8.0]\n\
elseif Var_Name==3  then[0.8559,140.5,959.8,2.3,0.9511,519.2,341.1,0.2,-3.0,-5.0,-8.0]\n\
elseif Var_Name==4 then [0.92,309.902,777.3213,2.3,0.79,584.6548,186.319,0.2,-3.0,-5.0,-8.0]\n\
elseif Var_Name==5 then [0.5,750,1400,2.3,0.91,678.9962,185.3471,0.2,-3.0,-5.0,-8.0]\n\
else [0.82,195.0686,802.5832,2.3,0.86,506.8706,208.7195,0.2,-3.0,-5.0,-8.0]";
char Inputs_comment[] = "\n\
Cultivar,\n\
Choose one:\n\
\n\
1=(C1) Ndinamagara  (SAS)\n\
2=(C2) Victoria (SAS)\n\
3=(C3) CIP388611.22 (SAS)\n\
4=(C4) Ndinamagara  (R-calculador de parametros)\n\
5=(C5) Victoria (R-calculador de parametros)\n\
6=(C6) CIP388611.22 (R-calculador de parametros)";
char Var_Name_name[] = "Var_Name";
char Var_Name_spec[] = "5";
...
char Thermal_conditions_spec[] = "2";
...
3==Warm";
char TC_name[] = "TC";
char TC_spec[] = "if Thermal_conditions==1 then[0,17,25]elseif Thermal_conditions==2 then[2,20,28]else[4,23,30]";
char TC_comment[] = "\n\
\n\
\n\
...
char RUEs_spec[] = "1";
char RUEs_comment[] = "\n\
Expresion  RUE afectada por senescencia\n\
\n\
if Tac<t50-0*d then RUE else RUE*(1-(Tac-t50+0*d)/(2*d))\n\
\n\
OBS. Mayo 2013. Para  revision porque usa parametros de la  antigua funcion FLINT (d y t50)\n\
Se reemplazo por 1";
...
char CC_name[] = "CC";
char CC_spec[] = "if DAE<=0 then 0 elseif canopy1>0 then canopy1 else 10^-6";
char CC_comment[] = "Canopy Cover";
char tm_name[] = "tm";
char tm_spec[] = "element([Inputs],2)";
char tm_description[] = "f0";
char tm_comment[] = "Initial fraction of light interception, (MJ / d)";
char te_name[] = "te";
char te_spec[] = "element([Inputs],3)";
char te_description[] = "R0";
char te_comment[] = "Rate of relative increase of light interception, (oC-1 * d-1)";
char ym_name[] = "ym";
char ym_spec[] = "element([Inputs],1)";
char ym_description[] = "fcl";
char ym_comment[] = "Maximum canopy Cover (Maximum fraction of light intercepted)";
char canopy_name[] = "canopy";
char canopy_spec[] = "ym*(exp(-(tm/(Tac*N))))*(1+(te-Tac)/(te-tm))*((Tac/te)^(te/(te-tm)))";
char N_name[] = "N";
char N_spec[] = "4.17";
char canopy1_name[] = "canopy1";
char canopy1_spec[] = "rdm*v*canopy+canopy";
char Total_dry_matter_production_name[] = "Total dry matter production";
char RUE_name[] = "RUE";
char RUE_spec[] = "element([Inputs],4)";
...
char r_name[] = "r";
char r_spec[] = "element([Inputs],5)";
char r_comment[] = "Max value of HI";
char s_0_name[] = "s";
char s_0_spec[] = "element([Inputs],6)";
char s_0_comment[] = "Asymptotic HI";
char DTY_name[] = "DTY";
char DTY_comment[] = "Dry tuber yield, (tn * ha-1)";
char t_name[] = "t";
char t_spec[] = "element([Inputs],7)";
char t_comment[] = "Slope HI";
char Part_name[] = "Part";
char Part_spec[] = "r * exp(-exp(-(Tac-s)/t))";
char Part_comment[] = "Partition dynamics";
char DMcont_name[] = "DMcont";
char DMcont_spec[] = "element([Inputs],8)";
...
node_data_line nodedata[] = {{"node00000", VALUELESS, 0, NULL, SPLIT, {0},
     ...
     {"node00592", REAL, 0, NULL, DERIVED, {0},
     ...
     {"node00413", REAL, 0, NULL, TABLE, {365, 0},
     {1, 4, 1, 0}, 6, -1.0E+100, 1.0E+100, VARIABLE, {Irrigation_name, Irrigation_spec, NULL, NULL}},
     {"node00414", REAL, 0, NULL, DERIVED, {0},
     {1, 4, 2, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {Irri_name, Irri_spec, NULL, Irri_comment}},
     {"node00418", REAL, 0, NULL, TABLE, {365, 0},
     {1, 4, 3, 0}, 5, -1.0E+100, 1.0E+100, VARIABLE, {PET_name, PET_spec, NULL, PET_comment}},
     {"node00419", REAL, 0, NULL, DERIVED, {0},
     {1, 4, 4, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {ETo_name, NULL, NULL, ETo_comment}},
     {"node00422", REAL, 0, NULL, TABLE, {365, 0},
     {1, 4, 5, 0}, 4, -1.0E+100, 1.0E+100, VARIABLE, {MinTemp_name, MinTemp_spec, NULL, NULL}},
     {"node00423", REAL, 0, NULL, TABLE, {365, 0},
     {1, 4, 6, 0}, 3, -1.0E+100, 1.0E+100, VARIABLE, {MaxTemp_name, MaxTemp_spec, NULL, NULL}},
     {"node00424", REAL, 0, NULL, TABLE, {365, 0},
     {1, 4, 7, 0}, 2, -1.0E+100, 1.0E+100, VARIABLE, {Rainfall_name, Rainfall_spec, NULL, NULL}},
     {"node00425", REAL, 0, NULL, DERIVED, {0},
     {1, 4, 8, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {Tmax_name, Tmax_spec, NULL, NULL}},
     {"node00427", REAL, 0, NULL, TABLE, {365, 0},
     {1, 4, 9, 0}, 1, -1.0E+100, 1.0E+100, VARIABLE, {Radiation_name, Radiation_spec, NULL, Radiation_comment}},
     {"node00428", REAL, 0, NULL, DERIVED, {0},
     {1, 4, 10, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {Tmin_name, Tmin_spec, NULL, NULL}},
     {"node00430", REAL, 0, NULL, DERIVED, {0},
     {1, 4, 11, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {Rain_name, Rain_spec, NULL, Rain_comment}},
     {"node00432", REAL, 0, NULL, DERIVED, {0},
     {1, 4, 12, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {PAR_name, PAR_spec, NULL, PAR_comment}},
     {"node00004", VALUELESS, 0, NULL, SPLIT, {0},
     {1, 5, 0}, 0, 0, 0, SUBMODEL, {Variety_name, NULL, NULL, NULL}},
     {"node00441", REAL, 0, NULL, DERIVED, {11, 0},
     {1, 5, 1, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {Inputs_name, Inputs_spec, NULL, Inputs_comment}},
     {"node00443", INTEGER, 0, NULL, DERIVED, {0},
     ...
     {"node00663", REAL, 0, NULL, DERIVED, {0},
     {1, 9, 1, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {Eo_name, NULL, NULL, Eo_comment}},
     {"arc00605", REAL, 0, NULL, DERIVED, {0},
     {1, 9, 2, 0}, 0, -1.0E+100, 1.0E+100, FLOW, {s_name, s_spec, NULL, s_comment}},
     {"node00667", REAL, 0, NULL, DERIVED, {0},
     {1, 9, 4, 0}, 0, -1.0E+100, 1.0E+100, COMPARTMENT, {CS_name, CS_spec, NULL, CS_comment}},
     {"arc00608", REAL, 0, NULL, DERIVED, {0},
     {1, 9, 5, 0}, 0, -1.0E+100, 1.0E+100, FLOW, {S_name, NULL, NULL, S_comment}},
     {"node00671", REAL, 0, NULL, DERIVED, {0},
     {1, 9, 6, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {To_0_name, NULL, NULL, To_0_comment}},
     {"node00673", REAL, 0, NULL, DERIVED, {0},
     ...
     {"node00832", VALUELESS, 0, NULL, SPLIT, {0},
     {1, 11, 1, 0}, 0, 0, 0, SUBMODEL, {Canopy_cover_name, NULL, NULL, NULL}},
     {"node00842", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 1, 1, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {CC_name, CC_spec, NULL, CC_comment}},
     {"node00844", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 1, 2, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {tm_name, tm_spec, tm_description, tm_comment}},
     {"node00846", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 1, 3, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {te_name, te_spec, te_description, te_comment}},
     {"node00850", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 1, 4, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {ym_name, ym_spec, ym_description, ym_comment}},
     {"node00955", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 1, 5, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {canopy_name, canopy_spec, NULL, NULL}},
     {"node01841", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 1, 6, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {N_name, N_spec, NULL, NULL}},
     {"node02937", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 1, 7, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {canopy1_name, canopy1_spec, NULL, NULL}},
     {"node00833", VALUELESS, 0, NULL, SPLIT, {0},
     {1, 11, 2, 0}, 0, 0, 0, SUBMODEL, {Total_dry_matter_production_name, NULL, NULL, NULL}},
     {"node01160", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 2, 1, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {RUE_name, RUE_spec, NULL, RUE_comment}},
     {"node01163", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 2, 3, 0}, 0, -1.0E+100, 1.0E+100, COMPARTMENT, {TDM_name, TDM_spec, NULL, TDM_comment}},
     {"arc00704", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 2, 4, 0}, 0, -1.0E+100, 1.0E+100, FLOW, {dW_name, NULL, NULL, dW_comment}},
     {"node00834", VALUELESS, 0, NULL, SPLIT, {0},
     {1, 11, 3, 0}, 0, 0, 0, SUBMODEL, {Tuber_production_name, NULL, NULL, NULL}},
     {"node01172", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 3, 1, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {r_name, r_spec, NULL, r_comment}},
     {"node01174", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 3, 2, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {s_0_name, s_0_spec, NULL, s_0_comment}},
     {"node01176", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 3, 3, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {DTY_name, NULL, NULL, DTY_comment}},
     {"node01178", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 3, 4, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {t_name, t_spec, NULL, t_comment}},
     {"node01180", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 3, 5, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {Part_name, Part_spec, NULL, Part_comment}},
     {"node01186", REAL, 0, NULL, DERIVED, {0},
     {1, 11, 3, 6, 0}, 0, -1.0E+100, 1.0E+100, VARIABLE, {DMcont_name, DMcont_spec, NULL, DMcont_comment}},
     {"node01188", REAL, 0, NULL, DERIVED, {0},
