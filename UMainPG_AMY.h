...
#include "Solanum.h"
//---------------------------------------------------------------------------
class TfrmMainPG_AMY : public TForm
{
__published:	// IDE-managed Components
        ...
        void __fastcall sbSelectYearsClick(TObject *Sender);
...
public:		// User declarations
        __fastcall TfrmMainPG_AMY(TComponent* Owner);
        __fastcall TfrmMainPG_AMY(TfrmMenu*,Solanum*);
};
//---------------------------------------------------------------------------
extern PACKAGE TfrmMainPG_AMY *frmMainPG_AMY;
//---------------------------------------------------------------------------
#endif
