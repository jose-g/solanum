//---------------------------------------------------------------------------
#ifndef UCropParameterAMH
#define UCropParameterAMH
//---------------------------------------------------------------------------
#include "Crop.h"
#include <Classes.hpp>
...
//---------------------------------------------------------------------------
class TfrmCropParameterAM : public TForm
{
__published:	// IDE-managed Components
        ...
        TRichEdit *RichEdit29;
        TRichEdit *RichEdit30;
        ...
        void __fastcall cbCropEnter(TObject *Sender);
        void __fastcall edNameChange(TObject *Sender);
        void __fastcall edNameClick(TObject *Sender);
        void __fastcall edNameExit(TObject *Sender);
        void __fastcall butAddCropClick(TObject *Sender);
        void __fastcall Button1Click(TObject *Sender);
private:	// User declarations
        Crop *cond;
        Crop *ListFavoriteCrop;
        bool Validate();
        ...
        int ItemSelected;
        void LoadListFavoriteCrop();
public:		// User declarations
        __fastcall TfrmCropParameterAM(TComponent* Owner);
        void EnterInformation(Crop*);
};
//---------------------------------------------------------------------------
extern PACKAGE TfrmCropParameterAM *frmCropParameterAM;
//---------------------------------------------------------------------------
#endif
