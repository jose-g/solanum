...
#pragma link "TeeURL"
#pragma resource "*.dfm"
TfrmGraph6PG *frmGraph6PG;
//---------------------------------------------------------------------------
__fastcall TfrmGraph6PG::TfrmGraph6PG(TComponent* Owner)
        : TForm(Owner)
{
  filename=NULL;
...
//---------------------------------------------------------------------------
void TfrmGraph6PG::EnterInformation(char* _cond)
{
strcpy(filename,_cond);
}
//---------------------------------------------------------------------------
void __fastcall TfrmGraph6PG::SpeedButton4Click(TObject *Sender)
{
Close();
}
//---------------------------------------------------------------------------
void __fastcall TfrmGraph6PG::chbCCClick(TObject *Sender)
{
...
void __fastcall TfrmGraph6PG::FormShow(TObject *Sender)
{
  tc1->Panel=tch1;
  FILE * pFile;
...
void __fastcall TfrmGraph6PG::sbSaveClick(TObject *Sender)
{
  ...
  if(sdSave->Execute())
  {
    ...
    if(sdSave->FilterIndex==1)
    {
      ...
      fprintf(pFileOutput,"%s %s\n","Day","   Total dry matter potential");
...
void __fastcall TfrmGraph6PG::sdSaveSelectionChange(TObject *Sender)
{
